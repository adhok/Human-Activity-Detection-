...
* For the purpose of prediction we project the scaled test data onto the principal directions.
* The resulting vectors are then used in the model and tested against the test data.
...
Good training and test accuracies are achieved the previous sections with one set of test and train data. A good way to make sure that the predictive modeling approach is robust is to run it with different combinations of test and train data.
