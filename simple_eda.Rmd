...
The assumptions of one way ANOVA test is as follows

* The observations should be independent of each other
* The observations need to be normally distributed
* Population variance is assumed to be the same across groups
