...
The aim of this project to effectively predict the activities using the gievn measurements via multinomial logistic regression as the predicting algorithm.
...
Before we feed the features into the logistic model, we need to make sure that the features are not collinear to each other. We will choose the variables that are not highly correlated with any other variables.
